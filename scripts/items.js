...
// 一、变种物品（sp- 前缀，11 个）
// 原版就有的资源，在繁星里做成独立版本。
// 数值抄原版（Items.java），显示名/描述用繁星的（bundles 里写）。
// 科技树全部挂繁星独立树（research 见各 JSON 文件）。
// ============================================

newItem("sp-lead");             // 铅（原版 lead 变种）—— 繁星科技树根节点
